...
alias log='docker run --rm -it --net docker-stack_elasticsearch svendowideit/elktail --url http://elasticsearch:9200 -i "graylog_deflector" -t "created" -f "%timestamp %message" container_name:'
